...
import { requestForReturningStates, enumAssignmentStateLowerCase } from '../../../utils';

const RequestForReturningStateDropdown = ({ selectedState, onChangeState }) => {
  const [show, setShow] = useState(false);

  const renderStateItems = () =>
    requestForReturningStates.map((stateItem) => (
      <div
        key={stateItem}
...
export default RequestForReturningStateDropdown;
